...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
    <div class="w-full mb-1">
        <div class="mb-4">
            ...
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Status</h1>
        ...
        <div class="items-center justify-end block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <a href="{{ route('status.tambah') }}" class="text-white bg-gray-600 hover:bg-gray-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5" type="button">
                Tambah Status
            </a>
        </div>
    </div>
        ...
        <div class="relative overflow-x-auto shadow-md">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-4">
                                ...
                                <form onsubmit="return confirm('Apakah anda yakin menghapus data status ini?')" action="{{ route('status.hapus', $status->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <p>Kamu belum mempunyai status</p>
                    @endforelse
                </tbody>
            </table>
        </div>
