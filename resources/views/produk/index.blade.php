...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
    <div class="w-full mb-1">
        ...
        <div class="items-center justify-end block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <a href="{{ route('produk.tambah') }}" class="text-white bg-gray-600 hover:bg-gray-500 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5" type="button">
                Tambah Produk
            </a>
        </div>
    </div>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-4">
                                <a href="{{ route('produk.ubah', $produk->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                <form onsubmit="return confirm('Apakah anda yakin menghapus data produk ini?')" action="{{ route('produk.hapus', $produk->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
